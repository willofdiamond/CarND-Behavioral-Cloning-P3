...
model.fit_generator(generateData(file_directory,train_lines,batch_size = 1), int((len(train_lines))/batch_size1), 5,1,None,generateData(file_directory,test_lines,batch_size = 1),int((len(test_lines))/batch_size1) )
